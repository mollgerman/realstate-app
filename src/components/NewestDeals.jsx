...
const NewestDeals = () => {
  return (
    <div className='py-10'>
        <p className='px-4 py-1 text-xs bg-orange-200 w-16 rounded-lg'>NEW</p>
        ...
        <div className="deals grid 2xl:grid-cols-5 gap-8 xl:grid-cols-4 lg:grid-cols-3 md:grid-cols-2 grid-cols-1 py-10">
            <div className="deal h-[350px] bg-orange-100 drop-shadow-2xl rounded-xl">
                ...
                <div className='flex space-x-5 items-center'>
                    <div className='flex items-center space-x-1'>
                        <IoBedOutline/>
                        <p className='text-sm text-gray-800'>5 bed</p>
                    </div>
                    <div className='flex items-center space-x-1'>
                       <GiBathtub/>
                       <p className='text-sm text-gray-800'>3 bat</p>
                    </div>
                    <div className='flex items-center space-x-1'>
                     <GiHomeGarage/>
                        <p className='text-sm text-gray-800'>1 gar</p>
                    </div>
                </div>
            ...
            <div className="deal h-[350px] bg-orange-100 drop-shadow-2xl rounded-xl">
                ...
                <div className='flex space-x-5 items-center'>
                    <div className='flex items-center space-x-1'>
                        <IoBedOutline/>
                        <p className='text-sm text-gray-800'>3 bed</p>
                    </div>
                    <div className='flex items-center space-x-1'>
                       <GiBathtub/>
                       <p className='text-sm text-gray-800'>2 bat</p>
                    </div>
            ...
            <div className="deal h-[350px] bg-orange-100 drop-shadow-2xl rounded-xl">
                ...
                <div className='flex space-x-5 items-center'>
                    <div className='flex items-center space-x-1'>
                        <IoBedOutline/>
                        <p className='text-sm text-gray-800'>4 bed</p>
                    </div>
                    <div className='flex items-center space-x-1'>
                       <GiBathtub/>
                       <p className='text-sm text-gray-800'>2 bat</p>
        ...
        <button className='bg-orange-200 px-5 py-2 rounded-md text-xl flex items-center space-x-2 hover:bg-orange-400'><span>View More</span> <AiOutlineDoubleRight/></button>
        </div>
    </div>
  )
}
